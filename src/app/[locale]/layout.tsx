  ...
  return (
    <html lang={locale}>
      <head>
        ...
        <meta property="og:image" content={logo_icon.src} />
        ...
        <link rel="icon" type="image/svg+xml" sizes="192x192" href={logo_icon.src} />
        <link rel="icon" type="image/svg+xml" sizes="32x32" href={logo_icon.src} />
      </head>
      <body
